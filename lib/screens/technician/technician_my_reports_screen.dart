...
import 'technician_create_ticket_screen.dart';

class TechnicianMyReportsScreen extends StatefulWidget {
  @override
  State<TechnicianMyReportsScreen> createState() => _TechnicianMyReportsScreenState();
}

class _TechnicianMyReportsScreenState extends State<TechnicianMyReportsScreen> {
  ...
  void _startNotifListener() {
    ...
    _notifSub = tp.fetchTickets(role: 'technician_as_requester', uid: uid).listen(
      (tickets) {
        if (_isFirstLoad) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => TechnicianCreateTicketScreen()),
        ),
